      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-white">
          ...
          {isOpen && (
            <button
              onClick={onNewChat}
              className="flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-blue-600 to-emerald-600 text-white rounded-lg hover:from-blue-700 hover:to-emerald-700 transition-all duration-200 text-sm font-medium"
            >
          ...
          {/* {!isOpen && (
            <button
              onClick={onNewChat}
              className="p-2 rounded-lg bg-gradient-to-r from-blue-600 to-emerald-600 text-white hover:from-blue-700 hover:to-emerald-700 transition-all duration-200"
...
const ChatInterface: React.FC<ChatInterfaceProps> = ({
  ...
  return (
    <div className="flex-1 overflow-y-auto p-6 space-y-6 mt-[5vh] ">
      {messages.map((message) => (
        ...
        >
          {/* AI Avatar */}
          {message.type === "ai" && (
            <div className="w-8 h-8 rounded-full bg-gradient-to-r from-blue-600 to-emerald-600 flex items-center justify-center flex-shrink-0">
            ...
            {message.image && (
              <div className="mb-3">
                <img
                  src={message.image}
                  alt="Uploaded"
                  className="w-[14vw] h-auto rounded-lg"
                />
              </div>
            )}
...
const InputBar: React.FC<InputBarProps> = ({
  ...
  return (
    <div
      className={`
        fixed bottom-0 right-0 bg-white border-t border-gray-200 p-4 z-20
        transition-all duration-300 ease-in-out
        ${sidebarOpen ? "left-[324px]" : "left-[70px]"}
    `}
    >
      {/* Attachments */}
  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <div className="flex-1 flex flex-col lg:ml-0">
        <div className="pt-16 lg:pt-0 pb-32 flex-1 flex flex-col min-h-0">
          {/* Chat Area */}
